    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 max-w-screen-2xl items-center justify-between">
          <Link href="/" className="flex items-center gap-2 mr-auto md:mr-6" aria-label="SimSim Garden Home">
            ...
            <span className="font-headline font-bold text-xl text-primary">SimSim Garden</span>
          </Link>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex justify-between items-center">
                    <Link href="/" className="flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
                      ...
                      <span className="font-headline font-bold text-lg text-primary">SimSim Garden</span>
                    </Link>
                    <SheetClose asChild>
